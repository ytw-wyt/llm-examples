...
template_3 = """
Can you generate Scenario 2 about how to teach fraction division based on the retrieved research paper? Please follow the below template.
...
def main():
    ...
    if generate_button: 
        ...
        if openai_api_key and uploaded_files:
            ...
            result = generate_course_section(openai_api_key, text_chunks, template_4)
            # st.info("🤖 Generated Course: " + result)
